...
namespace AccountApi.Wisa
{
    public class Student
    {
        ...
        public Student(string data, int schoolID)
        {
            ...
            preferedName = values[4].Trim();
            dateOfBirth = DateTime.ParseExact(values[5].Trim(), "d/M/yyyy", CultureInfo.InvariantCulture);
            wisaID = values[6].Trim();
            stemID = values[7].Trim();
            gender = values[8].Trim().Equals("M") ? GenderType.Male : GenderType.Female;
            stateID = values[9].Trim();
            placeOfBirth = values[10].Trim();
            nationality = values[11].Trim();
            street = values[12].Trim();
            houseNumber = values[13].Trim();
            houseNumberAdd = values[14].Trim();
            postalCode = values[15].Trim();
            city = values[16].Trim();
            classChange = DateTime.ParseExact(values[17].Trim(), "d/M/yyyy", CultureInfo.InvariantCulture);
        ...
        /// </summary>
        public string PreferedName { get => preferedName; }


        public string FullName { get => $"{(preferedName.Length > 0 ? preferedName : firstname)} {name}"; }
        ...
        public Student(JObject obj)
        {
            ...
            preferedName = obj.ContainsKey("PreferedName") ? obj["PreferedName"].ToString() : "";
        ...
        public static Student CreateTestStudent()
        {
            ...
            student.preferedName = "TestStudent";
